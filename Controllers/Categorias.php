<?php
	class Categorias extends Controllers{
		...
		public function Categorias()
		{
			...
			$data['page_title'] = "FAMILIA DE PRODUCTO <small>Tienda Virtual</small>";
				...
				if(empty($_POST['txtNombre']) || empty($_POST['txtDescripcion']) || empty($_POST['listStatus']) )
				{
					...
					if($intIdcategoria == 0)
					{
						...
						if($_SESSION['permisosMod']['u']){
							$request_cateria = $this->model->updateCategoria($intIdcategoria, $strCategoria, $strDescipcion, $intStatus);
							$option = 2;
