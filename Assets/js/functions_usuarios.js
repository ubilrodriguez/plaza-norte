...
window.addEventListener(
    ...
    function () {
      if (document.querySelector("#formUsuario")) {
        let formProductos = document.querySelector("#formUsuario");
        formProductos.onsubmit = function (e) {
          e.preventDefault();
        var intidcategoria  = document.querySelector("#listIDSubFamilia2").value;
          var strnomgru = document.querySelector("#txtnombreG").value;
          var strdesgru = document.querySelector("#txtdescripcionGrupo").value;
          (
            "#txtventasVinculado"
          ).value;
          if (
