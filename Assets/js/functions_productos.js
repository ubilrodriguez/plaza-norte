...
window.addEventListener('load', function() {
    if(document.querySelector("#formProductos")){
        ...
        formProductos.onsubmit = function(e) {
            e.preventDefault();
            let intlistGrupo = document.querySelector('#listGrupo').value;
    ...
    // $("#listIDSubFamilia").change(
    //     function () {
    //         $idproducto = $(this).value();
    //         $.post( base_url + "/Productos/getcategoriaslistado?op=combo",
    //         {idproducto:idproducto},function (data, status) {
    //             $("#listIDSubFamilia2").$html(data);
    //       }
    //   )
...
//       let ajaxUrl = base_url + "/Productos/getSelectNive3";
//       let request = window.XMLHttpRequest
//         ? new XMLHttpRequest()
//         : new ActiveXObject("Microsoft.XMLHTTP");
...
//       request.onreadystatechange = function () {
//         if (request.readyState == 4 && request.status == 200) {
//           document.querySelector("#listGrupo").innerHTML =
...
function fntCategoria1() {
    if (document.querySelector("#listIDSubFamilia")) {
      let ajaxUrl = base_url + "/Categorias/getSelectCategorias";
      let request = window.XMLHttpRequest
        ? new XMLHttpRequest()
        : new ActiveXObject("Microsoft.XMLHTTP");
      request.open("GET", ajaxUrl, true);
      request.send(); //envios de datos en el servid

      request.onreadystatechange = function () {
        if (request.readyState == 4 && request.status == 200) {
          document.querySelector("#listIDSubFamilia").innerHTML = request.responseText;
        //   $("#").selectpicker("render");
          $("#listIDSubFamilia").change(
            function () {
                // let ajaxUrl = base_url + "/Categorias/getFamilias";
                // console.log(ajaxUrl);
                // $idproduct= $(this).value();
                $.post( base_url + "/Productos/getFamilias",function (data) {
                    // $("#listIDSubFamilia2").$html(data);
                    $("#listIDSubFamilia2").selectpicker("render");
                    // console.log(data);
              }
          )
...
//   function fntROles(){
//     if(document.querySelector('#listIDSubFamilia2')){
//         let ajaxUrl = base_url+'/Usuarios/getSelectUsari';
//         let request = (window.XMLHttpRequest) ? 
//                     new XMLHttpRequest() : 
//                     new ActiveXObject('Microsoft.XMLHTTP');
//         request.open("GET",ajaxUrl,true);
...
//         request.onreadystatechange = function(){
//             if(request.readyState == 4 && request.status == 200){
//                 document.querySelector('#listIDSubFamilia2').innerHTML = request.responseText;
//                 $('##listIDSubFamilia2').selectpicker('render');
//             }
//         }
//     }
