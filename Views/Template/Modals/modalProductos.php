            ...
            <form id="formProductos" name="formProductos" class="form-horizontal">
              ...
              <div class="row">
               ...
               <label class="control-label">ID-Familia</label>
                ...
                <select class="form-control" data-live-search="true" id="listGrupo" name="listGrupo" required=""></select>
