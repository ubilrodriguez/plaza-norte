<?php 
		...
		public function selectnivel3()
	{
		...
		public function familia(  ){
			...
			// $sql = "SELECT * FROM `nivel2` WHERE idcategoria=?";
			$sql = "SELECT `idn2`, `idcategoria`, `nombre`, `descripcion` FROM `nivel2` ORDER BY `idcategoria` ASC";
			$arrData = array(0);
			// $arrData =bindValue(1,$this->$idcategoria);
